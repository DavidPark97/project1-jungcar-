...
$query2 = "SELECT r.popular , w.workout_name, w.img, w.part_img, r.percentage FROM recommend as r, workout as w WHERE r.popular = w.workout_idx and r.workout_idx = ".$workout_idx." and r.preference =".$prefer." and r.inbody =".$inbody." and r.gender =".$gender.";";
