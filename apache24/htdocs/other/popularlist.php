...
$query2 = "SELECT w.workout_idx, w.workout_name, w.img, p.percentage FROM popular as p, workout as w WHERE p.workout_idx = w.workout_idx  and p.preference =".$prefer." and p.inbody =".$inbody." and p.gender =".$gender.";";
