...
where board.board_idx = part_market.board_idx and user.user_idx = board.user_idx and part_type.part_type = part_market.part_type and part_type.part_type=$part_type order by market_idx desc;";

$query2 = "select count(*) as cnt, type_name from  part_type, part_market 
where part_type.part_type =  part_market.part_type and part_type.part_type=$part_type";
